...
# Create player and computer.
    ...
    game_display.blit(game_tank_sprite_player, (game_characteristics["cpu"]["position"]["x"], game_characteristics["grass"]["position"]["y"] - game_tank_sprite_cpu.get_height()))

    # Running the game.
    pygame.display.update()

    system_clock.tick(40)